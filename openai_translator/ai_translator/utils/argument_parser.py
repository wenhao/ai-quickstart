...
class ArgumentParser:
    def __init__(self):
        ...
        self.parser.add_argument('--model_type', type=str, required=True, choices=['DashScopeModel'], help='The type of translation model to use. Choose "DashScopeModel".')
    ...
    def parse_arguments(self):
        ...
        if args.model_type == 'DashScopeModel' and not args.openai_model and not args.openai_api_key:
            self.parser.error("--openai_model and --openai_api_key is required when using DashScopeModel")
        return args